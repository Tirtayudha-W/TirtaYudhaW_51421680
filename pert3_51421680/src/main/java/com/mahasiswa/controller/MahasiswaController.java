...
public class MahasiswaController {
    ...
    public void displayMahasiswaList(List<ModelMahasiswa> mahasiswaList){
        if(mahasiswaList.isEmpty()){
            ...
            for(ModelMahasiswa m: mahasiswaList){
                ...
                System.out.println("KOTA        : " + m.getKota());
                System.out.println("===========================");
            }
        }
    }
    ...
    public void addMahasiswa(String npm, String nama, String alamat, String kota, String email){
        ModelMahasiswa mahasiswaBaru = new ModelMahasiswa(0, npm, nama, alamat, kota, email);
        System.out.println("Controller Data: " + npm + ", " + nama + ", " + alamat + ", " + kota + ", " + email);
        mahasiswaDAO.addMahasiswa(mahasiswaBaru);
        displayMessage("Mahasiswa berhasil ditambahkan!");
    }
    
    public void updateMahasiswa(int id, String npm, String nama, String alamat, String kota, String email){
        ModelMahasiswa mahasiswaBaru = new ModelMahasiswa(id, npm, nama, alamat, kota, email);
